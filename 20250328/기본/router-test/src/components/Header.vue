<template>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark mt-2">
        ...
        <div :class="navClass">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <router-link class="nav-link" to="/"> 홈 </router-link link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" to="/about"> 소개 </router-link link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" to="/members"> 멤버 </router-link link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" v-bind:to="{name: 'vi'}"> 영상 </router-link link>
                </li>
            </ul>
        </div>
    </nav>
